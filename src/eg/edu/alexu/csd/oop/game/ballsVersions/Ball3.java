...
public class Ball3 implements Ball {
    ...
    private final String path = "/Balls/ball3.png";
    /** screen width */
    private int screenWidth = 1350;
    /** screen height */
    private int screenHeight = 700;

    public Ball3(int screenWidth, int screenHeight) {
    ...
    public GameObject generateThis(){
        return new ImageObject((int)(this.screenWidth*0.9*Math.random()), (int)(this.screenHeight*0.9*Math.random()), this.path,false,3);
    }
}
